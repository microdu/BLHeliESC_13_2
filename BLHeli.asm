...
Skypup_6A_Main					EQU 187
Skypup_6A_Tail					EQU 188
Skypup_6A_Multi				EQU 189
...
;BESCNO EQU Skypup_6A_Main
;BESCNO EQU Skypup_6A_Tail
;BESCNO EQU Skypup_6A_Multi
...
IF BESCNO == Skypup_6A_Main
MODE 	EQU 	0				; Choose mode. Set to 0 for main motor
$include (Skypup_6A.inc)			; Select Skypup 6A pinout
ENDIF

IF BESCNO == Skypup_6A_Tail
MODE 	EQU 	1				; Choose mode. Set to 1 for tail motor
$include (Skypup_6A.inc)			; Select Skypup 6A pinout
ENDIF

IF BESCNO == Skypup_6A_Multi
MODE 	EQU 	2				; Choose mode. Set to 2 for multirotor
$include (Skypup_6A.inc)			; Select Skypup 6A pinout
ENDIF
...
IF BESCNO == Skypup_6A_Multi
DEFAULT_PGM_MULTI_BEEP_STRENGTH	EQU 200	; 小苹果多轴电调, 声音响一些
ELSE
